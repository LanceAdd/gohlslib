...
}{
	{
		...
		playlist.Multivariant{
			...
			Variants: []*playlist.MultivariantVariant{
				{
					Bandwidth:        155000,
					AverageBandwidth: new(120000),
					Codecs: []string{
						"avc1.42c028",
						"mp4a.40.2",
					},
					Resolution: "1280x720",
					FrameRate:  new(float64(24.0)),
					Audio:      "aud1",
					Subtitles:  "sub1",
					URI:        "stream1.m3u8",
				},
...
`,
		playlist.Multivariant{
			...
			Variants: []*playlist.MultivariantVariant{
				{
					Bandwidth:        2177116,
					AverageBandwidth: new(2168183),
					Codecs: []string{
						"avc1.640020",
						"mp4a.40.2",
					},
					Resolution:     "960x540",
					FrameRate:      new(float64(60)),
					Audio:          "aud1",
					Subtitles:      "sub1",
					ClosedCaptions: "cc1",
				...
				{
					Bandwidth:        1268994,
					AverageBandwidth: new(1265132),
					Codecs: []string{
						"avc1.64001e",
						"mp4a.40.2",
					},
					Resolution:     "768x432",
					FrameRate:      new(float64(30)),
					Audio:          "aud1",
					Subtitles:      "sub1",
					ClosedCaptions: "cc1",
			...
			Renditions: []*playlist.MultivariantRendition{
				{
					Type:    playlist.MultivariantRenditionTypeAudio,
					GroupID: "audio",
					URI:     new("QualityLevels(125615)/Manifest(AAC_und_ch2_128kbps,format=m3u8-aapl)"),
					Name:    "AAC_und_ch2_128kbps",
				},
				{
					Type:    playlist.MultivariantRenditionTypeAudio,
					GroupID: "audio",
					URI:     new("QualityLevels(53620)/Manifest(AAC_und_ch2_56kbps,format=m3u8-aapl)"),
		...
		playlist.Multivariant{
			...
			Renditions: []*playlist.MultivariantRendition{
				...
				},
				{
					...
					Name:       "Angle2",
					Autoselect: true,
					URI:        new("Angle2/500kbs/prog_index.m3u8"),
				},
				{
					Type:       playlist.MultivariantRenditionTypeVideo,
					GroupID:    "500kbs",
					Name:       "Angle3",
					Autoselect: true,
					URI:        new("Angle3/500kbs/prog_index.m3u8"),
				},
				{
					Type:       playlist.MultivariantRenditionTypeAudio,
					GroupID:    "aac",
